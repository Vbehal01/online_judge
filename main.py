...
def read_admins(db: Session = Depends(get_db), current_admins: model.Admin = Depends(get_current_user)):
...
def read_admin(admin_id: int, db: Session = Depends(get_db), current_admins: model.Admin = Depends(get_current_user)):
...
def read_setters(db: Session = Depends(get_db), current_setter: model.Setter = Depends(get_current_user)):
...
def read_setter(setter_id: int, db: Session = Depends(get_db), current_setter: model.Setter = Depends(get_current_user)):
...
def read_solvers(db: Session = Depends(get_db), current_solver: model.Solver = Depends(get_current_user)):
...
def read_solver(solver_id: int, db: Session = Depends(get_db), current_solver: model.Solver = Depends(get_current_user),):
